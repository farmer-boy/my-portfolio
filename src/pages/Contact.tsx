      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        <div className="bg-gradient-to-r from-gray-800 to-gray-900 p-10 rounded-2xl border border-white border-opacity-20 text-center shadow-2xl animate-slideUp" style={{ animationDelay: "0.4s" }}>
          ...
          <div className="flex justify-center gap-6 flex-wrap">
            {[
              { icon: "🔗", label: "LinkedIn", url: resumeData.contact.linkedin },
              { icon: "💻", label: "GitHub", url: resumeData.contact.github },
              { icon: "�", label: "Instagram", url: resumeData.contact.instagram },
            ].map((social, index) => (
              <a
                key={index}
                href={social.url}
                ...
                className="bg-gray-700 hover:bg-white text-white hover:text-black px-6 py-3 rounded-lg font-semibold transition transform hover:scale-110 hover:-translate-y-1 shadow-lg duration-300 animate-slideUp"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
